...
namespace ListDriver {
    ...
    public partial class driverDataSet : global::System.Data.DataSet {
        ...
        public partial class DriverDataTable : global::System.Data.TypedTableBase<DriverRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DriverRow AddDriverRow(string LastName, string Initial, System.DateTime Date) {
        ...
        public partial class DriverRow : global::System.Data.DataRow {
            ...
            public string LastName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'LastName\' в таблице \'Driver\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string Initial {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Initial\' в таблице \'Driver\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime Date {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Date\' в таблице \'Driver\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsDateNull() {
                return this.IsNull(this.tableDriver.DateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetDateNull() {
                this[this.tableDriver.DateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ListDriver.driverDataSetTableAdapters {
    ...
    public partial class DriverTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Driver` WHERE ((`ID` = ?) AND ((? = 1 AND `LastName` IS NULL) OR (`L" +
                "astName` = ?)) AND ((? = 1 AND `Initial` IS NULL) OR (`Initial` = ?)) AND ((? = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Driver` (`LastName`, `Initial`, `Date`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Driver` SET `LastName` = ?, `Initial` = ?, `Date` = ? WHERE ((`ID` = ?) A" +
                "ND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Initial" +
                "` IS NULL) OR (`Initial` = ?)) AND ((? = 1 AND `Date` IS NULL) OR (`Date` = ?)))" +
                "";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ListDriver.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, LastName, Initial, [Date] FROM Driver";
        ...
        public virtual int Delete(int Original_ID, string Original_LastName, string Original_Initial, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string LastName, string Initial, global::System.Nullable<global::System.DateTime> Date) {
            if ((LastName == null)) {
        ...
        public virtual int Update(string LastName, string Initial, global::System.Nullable<global::System.DateTime> Date, int Original_ID, string Original_LastName, string Original_Initial, global::System.Nullable<global::System.DateTime> Original_Date) {
            if ((LastName == null)) {
